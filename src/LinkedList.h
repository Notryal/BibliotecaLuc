...
int ll_count(LinkedList* this, int (*fn)(void* element)); //Contador que recibe una linked list y un puntero a funcion, acumula segun lo que se le pase a la funcion y lo devuelve.
